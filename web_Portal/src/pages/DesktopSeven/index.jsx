...
const DesktopSevenPage = () => {
  ...
  return (
    <>
      <div className="bg-[#f8f5f9] flex flex-col font-poppins items-center justify-end ml-auto md:pr-10 sm:pr-5 pr-[41px]
       w-full" style={{
        ...
        <div className="flex flex-col items-center justify-end mx-auto w-full">
          <div className="flex md:flex-col flex-row gap-[35px] items-start justify-between w-full">
            <div className="flex flex-1 flex-col font-proximasoft gap-[23px] justify-start w-full p-[47px]">
              <Text
              ...
              <div className="bg-white-A700 flex flex-col font-poppins gap-[21px] items-center justify-center p-[30px] sm:px-5 rounded-[20px] shadow-bs3 w-full">
                <div className="w-full md:w-full flex items-center gap-5 border-2 border-gray-50 border-solid p-[21px] px-[6px] sm:px-5 rounded-[19px]">
                  <div className="flex flex-col h-full items-center justify-start ml-[34px] w-[71px]">
                    <Img
                  ...
                  <div className="flex w-full">
                    <div className="flex items-center flex-col w-full">
                      <Text
                          className="text-[19.52px] text-black-900 w-full"
                          size="txtPoppinsMedium1952"
                        >
                        Product Design As A Career
                      </Text>
                      <Text
                        className="text-[12.83px] text-blue_gray-700 tracking-[0.13px] w-full"
                      ...
                      <div className="w-full">
                        <Text
                            ...
                            rounded-[13px] w-[15%] mt-[3px] text-green-600 px-3 py-[2px]"
                            color="green_600_01"
                            size="sm"
                            variant="outline"
                          >Join Now</Text>
