            ...
            <div className="flex md:flex-col flex-row gap-[19px] items-start justify-between w-[97%] md:w-full">
              ...
              <div className="flex flex-col font-poppins gap-[17px] items-center justify-start w-[73%] md:w-full">
                <div className="overflow-x-auto w-full">
                  <div className="bg-white-A700 flex md:flex-col flex-row md:gap-5 items-center overflow-auto px-[18px] py-[18px] rounded-[10px] shadow-bs22 w-full">
                    <input
                      className="border border-gray-300_01 border-solid pb-[35px] pl-3 sm:pr-5 pr-[35px] pt-3.5
                       rounded-[12px] text-gray-500 text-sm tracking-[0.42px] w-full"
                      size="txtPoppinsLight14"
                      placeholder="Write Message to send it to All..."
                    />
                    <button>
                      <Img
