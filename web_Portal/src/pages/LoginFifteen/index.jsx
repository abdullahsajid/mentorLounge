  ...
  return (
    <>
      <div className="w-full h-screen flex justify-center items-center fixed z-[110]" style={{ backgroundColor: "rgba(0,0,0,0.5)" }}>
        <div
          className="bg-[#fff] flex flex-col font-poppins gap-[59px] h-[750px] 
           justify-start p-[25px] md:px-5 w-[42%] sm:w-full sm:h-[780px] sm:mx-[10px]"
          style={{ borderRadius: '20px' }}
        >
          <div className="h-[555px] md:h-[568px] md:ml-[0] mt-[15px] relative w-[95%] sm:w-full">
            <div className="absolute flex flex-col h-full inset-[0] items-center justify-center m-auto w-full">
              <div className="flex flex-col items-start justify-start w-full">
                ...
                <Text
                  className="ml-1 md:ml-[0] mt-[46px] sm:text-[16.51px] md:text-[18.51px] text-[19.51px] text-black-900_01"
                ...
                <div className="flex flex-row font-poppins items-start justify-start ml-1 md:ml-[0] mt-[22px] md:w-full w-full sm:flex-col gap-2 sm:gap-5">
          ...
          <Button className={`!text-gray-100 cursor-pointer h-[60px] leading-[normal] mb-[10px]
            ...
            text-[25.01px] text-center w-full flex justify-center items-center ${!isFormValid && "opacity-60 cursor-not-allowed"}`} onClick={(formData.role === 'mentor')?next:handleSignUp} disabled={!isFormValid}>
