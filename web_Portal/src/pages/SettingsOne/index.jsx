...
const SettingsOnePage = () => {
  ...
  return (
    <>
      <div className="bg-blue_gray-100_01 flex flex-col font-poppins items-center justify-end ml-auto w-full" style={{
        width:"calc(100% - 316px)"
      }}>
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          <div className="flex flex-col font-proximasoft gap-[42px] justify-start md:px-5 w-full">
            ...
            <div className="flex flex-col gap-[13px] items-start justify-start md:ml-[0] ml-[27px] w-[95%] sm:w-full">
              ...
              <div className="grid grid-cols-9 gap-[27px] sm:gap-0 sm:grid-cols-1 w-full">
                <div className="bg-white-A700 
                 p-7 sm:px-5 rounded-[30px] col-span-2 sm:w-full sm:col-span-9">
                  <div className="flex flex-col items-center justify-center
                   my-[7px]">
                    <div className="flex flex-col gap-[12.74px]">
                      <Button
                        className="cursor-pointer font-semibold leading-[normal] rounded-[10px]
                         shadow-bs23 sm:text-[16.38px] md:text-[18.38px] text-[20.38px] text-center w-full"
                        size="lg"
                      >
                        My Profile
                      </Button>
                      {/* <div className="flex flex-col items-center justify-center pl-[15.28px] pr-[19.11px] py-[12.74px]
                       rounded-[10px] shadow-bs23 w-full"> */}
                        <Button
                          className="sm:text-[16.38px] md:text-[18.38px] text-[20.38px] text-gray-900_87
